package com.programmersbox.timetexter.ui.theme
...
@Composable
fun TimeTexterTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
...
val currentColorScheme: ColorScheme
    @Composable
    get() {
        val darkTheme = isSystemInDarkTheme()/*AppCompatDelegate.getDefaultNightMode() == AppCompatDelegate.MODE_NIGHT_YES ||
